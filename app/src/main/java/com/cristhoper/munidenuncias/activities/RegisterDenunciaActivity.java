...
public class RegisterDenunciaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        location = findViewById(R.id.etUbicacion);

        imagen = findViewById(R.id.imagen_preview);
    ...
    public void registrarDenuncia(View view) {
        ...
        String usuario_id = String.valueOf(this.getIntent().getExtras().getInt("usuario_id"));

        String titulo = title.getText().toString();
        String descripcion = description.getText().toString();
        String ubicacion = location.getText().toString();

        if (titulo.isEmpty() || descripcion.isEmpty()) {
            Toast.makeText(this, "Los campos título y descripción son necesarios", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (mediaFileUri == null) {
            ...
            call = service.registrarDenuncia(usuario_id, titulo, descripcion, ubicacion);
        } else {
            ...
            //El RequestBody envía cadenas a través de la petición http; por ello, siempre hay que convertir los datos que se
            // envían a través de RequestBody a string
            RequestBody usuario_idPart = RequestBody.create(MultipartBody.FORM, usuario_id);
            ...
            call = service.registrarDenunciaConImagen(usuario_idPart, tituloPart, descripcionPart, ubicacionPart, imagenPart);
        }
